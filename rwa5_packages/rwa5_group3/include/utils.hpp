 ...
 * @brief this file contains the utility functions. These functions are used to
 * convert between different types of poses and orientations. They don't belong
 * to any class and are static methods.
 * @version 0.1
 * @date 2024-04-27
 *
 ...
 * Static methods allow any other class to use the functions without having to
...
class Utils {
 public:
   ...
   */
  static geometry_msgs::msg::Quaternion get_quaternion_from_euler(double roll,
                                                                  double pitch,
                                                                  double yaw) {
    tf2::Quaternion q;
   ...
   */
  static std::array<double, 3> get_euler_from_quaternion(
   ...
   */
  static geometry_msgs::msg::Pose multiply_poses(
      geometry_msgs::msg::Pose pose1, geometry_msgs::msg::Pose pose2) {
    KDL::Frame frame1;
    KDL::Frame frame2;
   ...
   * @return geometry_msgs::msg::Pose Pose built from the position and
   * orientation
   */
  static geometry_msgs::msg::Pose build_pose(
